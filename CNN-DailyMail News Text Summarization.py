...
# Reduce dataset size for faster training and testing
train_df = train_data.sample(n=1200, random_state=101)
validation_df = val_data.sample(n=300, random_state=101)
test_df = test_data.sample(n=300, random_state=101)
...
# Build summarization model using encoder-decoder architecture
summarizer_model = Model([encoder_inputs, decoder_inputs], decoder_output)

# Compile model with Adam optimizer and appropriate loss function
summarizer_model.compile(
